...
$(document).ready(function(){
	...
	var autorecarga_intervalo=5*60+0; // 5 minutos.
	...
	var ajuste=function(){
		...
		var panel_anchura=1920;
		
		var panel_altura=1080;
		...
		$('body').css('transform','scale('+(lienzo_altura/panel_altura)+')');
		
		$('body').css('transform-origin',(((lienzo_anchura-panel_anchura*(lienzo_altura/panel_altura))/1)*(panel_anchura/lienzo_anchura)/10)+'% 0');
	};
